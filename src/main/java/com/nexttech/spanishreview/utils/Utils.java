...
//        teacherScopes.add(ClassroomScopes.CLASSROOM_ROSTERS_READONLY);
    ...
    /**
     * Creates a two-directional map of Strings to Integers for conversion between the word on the worksheet to some
     * unique ID number. These lines of code were generated by a Python script at the root of the repository called
     * manual_tests.py.
     * @return A BiMap of Strings to Integers, which is stored as a field if it has already been generated once.
     */
    ...
    /**
     * Prints an array of Strings to the given PrintStream.
     * @param list The String[] to print
     * @param p The PrintStream to print it to
     */
